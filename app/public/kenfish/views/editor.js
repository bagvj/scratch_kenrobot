...
//         //         break;
//         //     case "python":
//         var result = brython.$eval(codeToEval);
//         //         break;
//         //     case "ruby":
...
(function() {
    ...
    var stopCode = "#!/usr/bin/python3 \nimport ctypes \nimport time \nll = ctypes.cdll.LoadLibrary \nLmst = ll(\"./libpycall.so\") \n\nLmst.StopTheFish()";
    var isRun

    function run() {
        isRun = !isRun;
        uploadToFish(isRun ? stopCode : editor.getValue());
    }

    function uploadToFish(code) {
        console.log(`uploadToFish: \n${code}`);
    }
