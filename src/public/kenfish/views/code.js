...
Code.renderContent = function() {
  ...
  // } else if (content.id == 'content_python') {
    ...
    if (typeof prettyPrintOne == 'function') {
      ...
      content.innerHTML = code;
      if(document.getElementById('content_Mypython').textContent != content.textContent)
      {
...
Code.init = function() {
  ...
  Code.bindClick('openButton', Code.openPrj);
  Code.bindClick('saveButton', Code.savePrj);
...
Code.initLanguage = function() {
  ...
  document.getElementById('tab_blocks').textContent = '';
...
//打开项目
Code.openPrj = function() {
	winform.openBlocklyPrj();
}

//保存项目
Code.savePrj = function() {
    var xmlDom = Blockly.Xml.workspaceToDom(Code.workspace);
    var xmlText = Blockly.Xml.domToPrettyText(xmlDom);
	winform.saveBlocklyPrj(xmlText);
}
